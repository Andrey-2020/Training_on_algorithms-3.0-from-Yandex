...
Если то, что выпало из окна и то, что стоит на первом месте в деке (самый маленький элемент) не совпадает то можно утверждать, что этого числа уже нет в деке. Потому, что меньший элемент уже вытолкнул данное число.
